...
const journeys: Record<Role, { emoji: string; label: string; color: string; bg: string; steps: { icon: string; title: string; desc: string }[] }> = {
  ...
  venue: {
    ...
    steps: [
      ...
      { icon: "🎒", title: "Register caddy", desc: "Tambahkan roster caddy aktif di venue Anda — mereka akan terhubung ke profil platform." },
      { icon: "✅", title: "Manage bookings", desc: "Confirm permintaan tee time, assign caddy, dan set status siap bermain." },
  ...
  caddy: {
    ...
    steps: [
      ...
      { icon: "📱", title: "Track schedule", desc: "Lihat semua penugasan mendatang di tab Caddy profil Anda." },
