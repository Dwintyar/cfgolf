            ...
            <div className="flex gap-3">
              {[
                ...
                <div
                  key={label}
                  title="Coming soon"
                  className="relative flex-1 flex items-center justify-center gap-2 h-11 rounded-xl border border-border/30 bg-card/40 text-sm font-medium text-muted-foreground/40 cursor-not-allowed select-none"
                >
                  {icon}
                  {label}
                  <span className="absolute -top-2 left-1/2 -translate-x-1/2 text-[9px] font-semibold bg-muted text-muted-foreground/60 px-1.5 py-0.5 rounded-full whitespace-nowrap">
                    Coming soon
                  </span>
                </div>
              ))}
