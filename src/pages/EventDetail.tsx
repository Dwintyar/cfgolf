...
import {
  ...
  ClipboardCheck, Play, CheckCircle, Package, Lock, Car, UserCheck, ChevronRight, Pencil, Plus, RefreshCw, Clock, Download, Flag, Backpack, User, Monitor, Share2, MessageCircle, ArrowLeft
} from "lucide-react";
      ...
      <div className="golf-card p-4 border-primary/30 bg-primary/5">
        ...
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm font-bold text-primary flex items-center gap-1.5">
            <Flag className="h-4 w-4" /> Flight Level Saya
          </p>
